...
public class CreateDirectory extends javax.swing.JFrame {
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        try{
            p = Runtime.getRuntime().exec(new String[]{ "sh", "-c" , " cd " + location + " && mkdir " + Fname });
            p.waitFor();
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(CreateDirectory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
