...
public class CopyDirectory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Copy Directory");
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        try{
            p = Runtime.getRuntime().exec(new String[]{ "sh", "-c" , "cd " + oldLocation + " && cp -r " + oldLocation+" "+newLocation });
            p.waitFor();
        } catch (IOException | InterruptedException ex) {
            Logger.getLogger(CreateFile.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        JOptionPane.showMessageDialog(null,"Directory Copied successfully");
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(CopyDirectory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
